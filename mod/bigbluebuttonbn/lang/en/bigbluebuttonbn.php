...
$string['bbbinvalidcalendareventoffset'] = 'The calendar event offet must be a zero or positive no greater than 999.';
...
$string['config_hidepresentationfile_editable'] = 'Hide presentation file from viewers editable';
$string['config_hidepresentationfile_editable_description'] = 'Controls whether hiding the presentation file from viewers can be controlled on an instance basis.';
$string['config_hidepresentationfile_default'] = 'Hide presentation file from viewers default';
$string['config_hidepresentationfile_default_description'] = 'Controls the default option for hiding the presentation file from viewers';
...
$string['config_moderatorscanjoinearly_editable'] = 'Moderators can join early editable';
$string['config_moderatorscanjoinearly_editable_description'] = 'Whether the moderators can join early setting can be changed for meetings.';
$string['config_moderatorscanjoinearly_default'] = 'Moderators can join early default';
$string['config_moderatorscanjoinearly_default_description'] = 'The default value for allowing moderators to join early.';
$string['config_calendareventoffset_editable'] = 'Calendar event offset editable';
$string['config_calendareventoffset_editable_description'] = 'Controls whether the calendar event offset can be changed.';
$string['config_calendareventoffset_default'] = 'Calendar event offset default';
$string['config_calendareventoffset_default_description'] = 'The default number of minutes for the calendar event offset.';
...
$string['mod_form_field_startingtime'] = 'Start';
$string['mod_form_field_closingtime'] = 'Close';
$string['mod_form_field_calendareventoffset'] = 'Calendar offset (in min)';
$string['mod_form_field_calendareventoffset_help'] = 'How many minutes should the time of the calendar event be delayed from the Open time?';
...
$string['mod_form_field_moderators_can_join_early'] = 'Moderators can join early';
$string['mod_form_field_moderators_can_join_early_help'] = 'Are modderators allowed to join the meeting before the specified opening time?';
...
$string['calendareventoffset_description_minute_early'] = 'The meeting opens 1 minute early.';
$string['calendareventoffset_description_minutes_early'] = 'The meeting opens {$a} minutes early.'; //^
$string['calendareventoffset_description_minute_late'] = 'The meeting opens 1 minute late.'; //^
$string['calendareventoffset_description_minutes_late'] = 'The meeting opens {$a} minutes late.'; //^
...
$string['view_section_title_presentation_hidden'] = 'Presentation file is hidden from viewers.';
$string['mod_form_field_hide_presentation_file'] = 'Hide the presentation file from viewers.';
$string['mod_form_field_hide_presentation_file_help'] = 'Should the presentation file be hidden from viewers?';
...
$string['view_message_conference_wait_for_start_time'] = 'The session is not open yet';
